...
import com.tongge.common.dataUtils.FileUtils;
...
public class IntentUtils {
    ...
    public static Intent getInstallAppIntent(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(AppManger.getInstance().currentActivity(), "com.your.package.fileProvider", file);
    ...
    public static Intent getLaunchAppIntent(String packageName) {
        return AppManger.getInstance().currentActivity().getPackageManager().getLaunchIntentForPackage(packageName);
    }
